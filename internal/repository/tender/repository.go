...
type Repository interface {
	...
	Edit(ctx context.Context, tenderID string, tender model.Tender) (model.Tender, error)
	RollbackVersion(ctx context.Context, tenderID string, version int) (model.Tender, error)
